...
const Profile = () => {
    ...
    const fetchUser = async () => {
        try {
            const res = await axios.get('https://fsd-cloud.onrender.com/profile', { withCredentials: true })
            setUser(res.data)
    ...
    const handleDelete = async (postId) => {
        await axios.delete(`https://fsd-cloud.onrender.com/delete/${postId}`, { withCredentials: true });
        setPosts(posts.filter(post => post._id !== postId))
    };

    const handleLogout = async () => {
        await axios.get('https://fsd-cloud.onrender.com/logout', { withCredentials: true })
        navigate('/login')
    }
